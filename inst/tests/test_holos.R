...
test <- ee_sensor_agg_get(sensor_id = 1625, weeks = 2)
test1 <- ee_sensor_agg_get(sensor_id = 1625, month = 1)
test2 <- ee_sensor_agg_get(sensor_id = 1629, hours = 2, minutes = 3, seconds = 4)
