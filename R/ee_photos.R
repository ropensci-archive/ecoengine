...
ee_photos <- function(page = NULL, 
    ...
    photos_data$latitude <- suppressWarnings(as.numeric(as.character(photos_data$latitude)))
    photos_data$longitude <- suppressWarnings(as.numeric(as.character(photos_data$longitude)))
